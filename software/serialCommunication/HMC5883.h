...
int hmc5883_init();
int getDataFromHMC5883(i2c_struct * i2c_instance, float * heading, unsigned long delay);

// Configuration Methods
void hmc5883_SetScale( i2c_struct * i2c_instance, uint16_t sampling_mode, unsigned long delay );
...
uint8_t hmc5883_Write( i2c_struct * i2c_instance, uint8_t address, uint8_t byte, unsigned long delay);
